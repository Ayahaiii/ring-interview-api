...
import com.monetware.ringinterview.business.pojo.dto.team.TeamGroupResDTO;
...
import com.monetware.ringinterview.business.service.project.TeamService;
...
public class TeamController {
    ...
    @MonetwareAuthorize(role = AuthorizedConstants.RT_MEMBER_ADD)
    ...
    @MonetwareAuthorize(role = AuthorizedConstants.RT_MEMBER_VIEW)
    ...
    @MonetwareAuthorize(role = AuthorizedConstants.RT_MEMBER_DELETE)
    ...
    @MonetwareAuthorize(role = AuthorizedConstants.RT_MEMBER_EXPORT)
    ...
    @MonetwareAuthorize(role = AuthorizedConstants.RT_MEMBER_LIST)
    public ResultData<PageList> getTeamUserList(@RequestBody TeamUserSearchVO teamUserSearchVO) throws IOException {
        return new ResultData("获取成功", teamService.getTeamUserList(teamUserSearchVO));
    }

    @PostMapping("agree")
    @ApiOperation(value = "同意申请")
    @MonetwareAuthorize(role = AuthorizedConstants.RT_MEMBER_EDIT)
    ...
    @MonetwareAuthorize(role = AuthorizedConstants.RT_MEMBER_GROUP_ADMIN)
